...
| Last WP-F04 Checkpoint | `5fd94508dc8e4a98a5e78fe344fe89b9c1c7ee95` — static/browser gates passed; emulator Auth+Firestore integration passed; emulator Hosting/Functions smoke remained unstable |
| Generator Applied | `scripts/wp-f04-rebaseline-to-live-firebase.cjs` — remove Emulator Suite dependency and make nocschedule1/nocmduscheduler the canonical managed Firebase target |
...
| Blocking Issue | None until live-managed rebaseline QA runs |
...
| WP-F04 | PUSHED_UNVERIFIED | Rebaselined from Emulator Suite to direct managed Firebase project |
